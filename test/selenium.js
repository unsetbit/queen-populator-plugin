...
theModule = mocks.loadFile(path.resolve(path.dirname(module.filename), '../lib/selenium.js'),{
	'wd': mockWd
});
...
var Populator = theModule.SeleniumPopulator,
	create = theModule.create,
	createClient = theModule.createSeleniumClient;
